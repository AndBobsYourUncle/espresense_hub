...
export default function NodeInspectionPanel({ nodes }: Props) {
  ...
  return (
    <div
      ...
      className="absolute z-20 inset-x-2 top-2 max-h-[calc(100%-1rem)] sm:inset-auto sm:top-16 sm:right-4 sm:w-[300px] sm:max-w-[90vw] bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-lg flex flex-col"
    >
